...
rent or mortgage payment, utilities, phones, cable. The program should then display the total monthly cost of these expenses, and then total
...
int main()
{
	...
	// Prepare the program
	cout << "Welcome to the utilities calculator program!\n";
	cout << "This program takes inputs include expenses, rent, mortgage payments, utilities, phones, and cable, and calculates the total monthly and annual costs of these expenses!\n";
